...
export const getTrainerBanks = async (trainer_id) => {
  try {
    const response = await api.get(
      `/api/getTrainerBanks?trainer_id=${trainer_id}`,
    );
    return response;
  } catch (error) {
    throw error;
...
export const getWebsiteDashboard = async (payload) => {
  try {
    const response = await api.post(`/api/getWebsiteDashboard`, payload);
    return response;
  } catch (error) {
    throw error;
  }
...
export const topPerformingChannelReport = async (payload) => {
  try {
    const response = await api.post(`/api/getTopPerformingReport`, payload);
    return response;
  } catch (error) {
    throw error;
  }
